...
export default function ExpenseTable({allExpenses,fecthAllExpenses}) {
  ...
  <TableContainer component={Paper}>
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell sx={{minWidth:2}} >SL</TableCell>
        ...
        <TableBody>
          ...
          allExpenses.map((row,index) => (
            ...
            >
              ...
              <TableCell>
                <Button component={Link} to={`/edit/${row._id}`} sx={{minWidth:2}} variant='contained' color='info'>Edit</Button>
                <Button onClick={()=> handleDelete(row?._id)} sx={{minWidth:2}} variant='contained' color='error'>Delete</Button>
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
